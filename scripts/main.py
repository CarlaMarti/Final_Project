...
@click.option(
    "-corr", "--correlations", is_flag=True, help="See the relations between variables."
)
@click.option(
    "-g", "--graphs", is_flag=True, help="Graph the relationships with Attrition Flag."
)
def main(
    dataset,
    understanding,
    ...
    if exploratory_a:
        ...
        exploring(
            df_to_explore, plot_general_distributions, categorical_eda, numerical_eda
        )
