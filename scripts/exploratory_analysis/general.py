...
def plot_general_distributions(df_to_explore):
    fig, ((ax1, ax2, ax3, ax4), (ax5, ax6, ax7, ax8), (ax9, ax10, ax11, ax12), (ax13, ax14, ax15, ax16)) = plt.subplots(nrows=4, ncols=4, figsize=(15, 15))
    
    plt.subplots_adjust(hspace=0.5, wspace=0.5)  # Ajuste de espaciado vertical y horizontal
